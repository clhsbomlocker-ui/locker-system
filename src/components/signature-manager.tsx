    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {/* Locker rules - displayed for signatories to read before signing */}
            <div className="border rounded-md p-3 max-h-48 overflow-auto bg-gray-50 text-sm leading-relaxed">
